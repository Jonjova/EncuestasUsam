                                ...
                                <div class="card wizard-card" data-color="blue" id="wizardProfile">
                                    <form id="CrearProyecto" class="needs-validation">
                                        ...
                                        <div class="wizard-navigation">
                                            <ul>
                                                <li><a href="#datosProyecto" data-toggle="tab">Informaci&oacute;n</a>
                                                </li>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input name="NOMBRE_PROYECTO" id="NOMBRE_PROYECTO"
                                                                    ...
                                                                    placeholder="Nombre" id-data="validationCustom01">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="ID_TIPO_INVESTIGACION"
                                                                    id="ID_TIPO_INVESTIGACION" class="custom-select"
                                                                    required id-data="validationCustom03"></select>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-sm-offset-1">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <button type="button" class="btn btn-success "
                                                                    data-toggle="modal" data-target="#modalAlumno">
                                                                    <i class="fas fa-plus-circle"></i>
                                                                </button>
                                                            </div>
                                                        </div>
