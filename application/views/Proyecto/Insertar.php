                                                ...
                                                <div class="col-sm-6" id="col_persona">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="DESCRIPCION" id="DESCRIPCION" placeholder="Descripción"  rows="4" cols="50" class="form-control mb-2 mr-sm-2 " id-data="validationCustom02" required></textarea>
                                                        </div>
                                                    </div>
