                ...
                <ul class="nav navbar-nav ml-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="<?php echo base_url();?>Cuenta/cambiar"><i
                                    class="fas fa-key"></i> Cambiar Contrase&ntilde;a</a>
                            <a class="dropdown-item" href="<?php echo base_url();?>Cuenta/persona"><i
                                    class="fas fa-user-edit"></i> Editar Perfil</a>
                            <a class="dropdown-item" href="<?php echo base_url()?>Accesos/logout"><i
                                    class="fas fa-user-times"></i> Cerrar Sesion</a>
                        </div>
                    </li>
                </ul>
            </div>
    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                <!-- <p>Dummy Heading</p> -->
                <li class="active">
                    <a href="<?php echo base_url();?>Accesos/home"><i class="fas fa-home"></i> Inicio</a>
                </li>

                <?php if($this->session->userdata('ID_TIPO_USUARIO') == 2): ?>
                <li>
                    <a href="#usersSubmenu" data-toggle="collapse" aria-expanded="false"><i class="fas fa-users"></i>
                        Usuarios</a>
                    <ul class="collapse list-unstyled" id="usersSubmenu">
                        <li>
                            <a href="<?php echo base_url();?>Usuario/usuarios"><i class="fas fa-eye"></i>
                                Ver Usuarios</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="#coordinadorSubmenu" data-toggle="collapse" aria-expanded="false"> <i
                            class="fas fa-user-cog"></i> Coordinadores</a>
                    <ul class="collapse list-unstyled" id="coordinadorSubmenu">
                        <li>
                            <a href="<?php echo base_url();?>Coordinador/coordinador"><i class="fas fa-plus-circle"></i>
                                Registrar</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url();?>Coordinador/coordinadores"><i class="fas fa-eye"></i> Ver
                                Registrados</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="#DocenteSubmenu" data-toggle="collapse" aria-expanded="false"> <i
                            class="fas fa-chalkboard-teacher"></i> Docentes</a>
                    <ul class="collapse list-unstyled" id="DocenteSubmenu">
                        <li>
                            <a href="<?php echo base_url();?>Docente/docente"><i class="fas fa-plus-circle"></i>
                                Registrar</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url();?>Docente/docentes"><i class="fas fa-eye"></i> Ver
                                Registrados</a>
                        </li>
                    </ul>
                </li>
                ...
                <?php if($this->session->userdata('ID_TIPO_USUARIO') == 1 || $this->session->userdata('ID_TIPO_USUARIO') == 3): ?>
                <li>
                    <a href="#AsignaturasSubmenu" data-toggle="collapse" aria-expanded="false"><i
                            class="fas fa-book-open"></i> Asignaturas</a>
                    <ul class="collapse list-unstyled" id="AsignaturasSubmenu">
                        <li>
                            <a href="<?php echo base_url();?>Asignatura/asignatura"><i class="fas fa-plus-circle"></i>
                                Registrar</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url();?>Asignatura/asignaturas"><i class="fas fa-eye"></i> Ver
                                Registradas</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url();?>Asignatura/asignar"><i class="fas fa-user-plus"></i>
                                Asignar</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url();?>Asignatura/asignadas"><i class="fas fa-eye"></i> Ver
                                Asignadas</a>
                        </li>
                    </ul>
                </li>
