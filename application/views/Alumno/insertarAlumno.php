                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="SEGUNDO_NOMBRE_PERSONA" id="SEGUNDO_NOMBRE_PERSONA" type="text"
                                        class="form-control required" placeholder="2do Nombre" required>
                                </div>
                                <div class="form-group col-md-6">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="SEGUNDO_APELLIDO_PERSONA" id="SEGUNDO_APELLIDO_PERSONA" type="text"
                                        class="form-control required" placeholder="2do Apellido" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Sexo</label>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="DUI" id="DUI" type="text" class="form-control required"
