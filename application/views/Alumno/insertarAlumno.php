                                    ...
                                    <ul class="nav nav-tabs" id="myTab" role="tablist" style="font-size: 13px;">
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact"
                                                role="tab" aria-controls="contact" aria-selected="false">Residencia</a>
                                        </li>
                                    </ul>
                                </nav><br>
                                    ...
                                    <div class="tab-pane fade show active" id="home" role="tabpanel"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input name="SEGUNDO_NOMBRE_PERSONA" id="SEGUNDO_NOMBRE_PERSONA"
                                                    type="text" class="form-control" placeholder="2do Nombre">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Primer Apellido</label>
                                                <input name="PRIMER_APELLIDO_PERSONA" id="PRIMER_APELLIDO_PERSONA"
                                                    type="text" class="form-control required" placeholder="1er Apellido"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input name="SEGUNDO_APELLIDO_PERSONA" id="SEGUNDO_APELLIDO_PERSONA"
                                                    type="text" class="form-control" placeholder="2do Apellido">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Sexo</label>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input name="CORREO_INSTITUCIONAL" id="CORREO_INSTITUCIONAL" type="text"
                                                    ...
                                                    placeholder="eje: estudiante@liveusam.edu.sv" required>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                        ...
                                        <div class="form-row ">
                                            <div class="form-group col-md-8 offset-md-2">
                                                ...
                                                <select name="DEPARTAMENTO" id="DEPARTAMENTO"
                                                    class="custom-select required" onblur="validaSelect(this);"
