            ...
            <form action="">
                <table id="Profesiones" class="table table-hover table-striped dt-responsive nowrap"
                                    ...
                                    <div class="card wizard-card" data-color="blue" id="wizardProfile">
                                        <form id="UpdateProfesion" class="needs-validation">
                                            ...
                                            <div class="wizard-navigation">
                                                <ul>
                                                    <li><a href="#profesion" data-toggle="tab">Informaci&oacute;n</a>
                                                    </li>
                                                </ul>
                                            </div>
                                                    ...
                                                    <div class="row" style="display: block;">
                                                        ...
                                                        <div class="col-sm-8 col-sm-offset-2">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="hidden" name="ID_PROFESION_UPDATE"
                                                                    id="ID_PROFESION_UPDATE">
                                                                <input type="text" name="NOMBRE_PROFESION_UPDATE"
                                                                    id="NOMBRE_PROFESION_UPDATE" class="form-control"
